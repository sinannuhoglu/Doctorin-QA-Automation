...
Özellik: Poliçe modülü - Tedavi Planı Paketler yönetimi
  ...
  Senaryo: "Kasım Özel" paketinin arama ile filtrelenmesi
    ...
    Ve Tedavi planı paket arama alanına "Kasım Özel" yazar ve arama yapar

    # 3) FİLTRE SONUCUNUN DOĞRULANMASI
    O zaman Tedavi planı paket listesi "Kasım Özel" için filtrelenmiş olmalıdır


  Senaryo: "Kasım Özel" paketinin düzenlenmesi
  ...
  Senaryo: "Kasım Özel" paketinin silinmesi
